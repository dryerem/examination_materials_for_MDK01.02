...
- В файле ResultView.xaml.cs в строке 30 Assembly.GetExecutingAssembly().Location возвращаеть путь к исполняемому файлу. Решается несколькими способами, один из которых относительный путь. Можно просто оставить имя файла. 
